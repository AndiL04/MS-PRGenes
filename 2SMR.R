...
setwd("C:/Users/andya/OneDrive/Desktop/MS Bayes&2SMR/2SMR")
anno <- read.delim("C:/Users/andya/OneDrive/Desktop/Work/2SMR/GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.lookup_table.txt.gz")
...
##"Spleen", "Whole Blood","Brain Cerebellum","Artery Coronary","Brain Amygdala"
##,"Brain Anterior cingulate cortex BA24"
##,"Brain Caudate basal ganglia","Brain Cerebellar Hemisphere","Brain Cortex",
...
for (i in Tissue){
  ...
  ###clumping
  cat("clumping...may take loooooooooooooooooooooooooooooonger","\n")
...
for (i in Tissue){
  addr <- paste("C:/Users/andya/OneDrive/Desktop/MS Bayes&2SMR/2SMR/2SMR results/",i,"_2SMR.txt",sep = "")
  df <- read.delim(addr, sep = ",", row.names = 1)
  df$FDR <- p.adjust(df$pval, method = "BH",n = length(df$pval))
  
  addr1 <- paste("C:/Users/andya/OneDrive/Desktop/MS Bayes&2SMR/2SMR/2SMR results/",i,"_2SMR.csv",sep = "")
  write.csv(df, addr1)
}
